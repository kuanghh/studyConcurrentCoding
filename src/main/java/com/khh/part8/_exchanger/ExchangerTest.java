package com.khh.part8._exchanger;
 ...
 *
 * 下面代码应用场景:Exchanger可以用于遗传算法，遗传算法里需要选出两个人作为交配对象，这时候会交换两人的数据，
        ...
        threadPool.execute(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    System.out.println("在线程A接收到B的数据 ，B录入的是 : " + B);
...
//                    String A = exgr.exchange("B");  //书上的代码，是错误的，应该是交换String B,而不是"B"
